# MoAI v.0.1.7 — Codebase Analysis
...
With 21 documents, this generates thousands of (query, document) training pairs.
...
With 21 documents, ~9,000 training samples are generated (max 20 proper entities per document × 22 templates). Only capitalized phrases and acronyms are used as entities — generic words are excluded to avoid nonsensical training data.

#### Training Time

| Configuration | Samples | Batches/epoch | Approx. time |
|--------------|---------|---------------|-------------|
| Default (all cores) | ~9,000 | ~11,000 | ~3 hours |
| `--threads 4` (16-core machine) | ~9,000 | ~11,000 | ~12 hours |
| `--threads 2` (16-core machine) | ~9,000 | ~11,000 | ~24 hours |
